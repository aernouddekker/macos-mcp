 ...
 * reads the source event's properties, creates a copy in the target calendar,
 * then deletes the original. The new event will have a fresh uid.
 */
export async function moveEvent(uid: string, targetCalendar: string) {
...
tell application "Calendar"
  ...
  return { oldUid: uid, newUid: trimmed, targetCalendar };
}
